...
print('=============================================================')
message="This is a scrpit to create a quantized model using normal Torch-Quantization out of a model pretrained with PyTorch lightning"
print(message)
print('=============================================================')
...
def main():
    ...
    before_qat=save_models(qmodel,qmodel.named_parameters(),qmodel.named_modules(), "Prepared")


    #if you set as inplace=True, the model params will be mutated
    torch.quantization.convert(qmodel,inplace=True)
    
    after_qat=save_models(qmodel,qmodel.model.named_parameters(),qmodel.named_modules(), "After converted")
    trainer=pl.Trainer()
    ...
    for i,j in qmodel.model.named_parameters():
        print(i)
    for _ in qmodel.named_parameters():
        print(_)
    
    print('===modules===')
    for _,k in qmodel.named_modules():
        print(_)

#    trainer.fit(qmodel)
    qmodel.eval()
    for i,j in qmodel.state_dict().items():
        print(i)#,j)
